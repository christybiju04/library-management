...
class GUITest5 implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e)
	{
            try
            {
                ...
                {
                    String query1="UPDATE employee SET gmail='"+text3.getText()+"' WHERE username='"+text1.getText()+"'";
                    stmt.executeUpdate(query1);
                    JOptionPane.showMessageDialog(panel1,"record updated");
                }
                if (e.getSource() == button3) 
                { 
                    String query2 = "DELETE FROM employee WHERE username = '" +text1.getText()+ "'";
                    int rowsDeleted = stmt.executeUpdate(query2);
                    if (rowsDeleted > 0) {
                        JOptionPane.showMessageDialog(frame1, "Record deleted successfully!");
                    } else {
                        JOptionPane.showMessageDialog(frame1, "Failed to delete!");
                    }
                }
